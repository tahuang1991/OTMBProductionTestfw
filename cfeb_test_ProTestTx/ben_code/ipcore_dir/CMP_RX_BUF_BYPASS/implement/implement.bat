...
COPY cmp_rx_buf_bypass_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\cmp_rx_buf_bypass_top.ucf -p xc6vlx195t-ff1156-1 cmp_rx_buf_bypass_top.ngc cmp_rx_buf_bypass_top.ngd
