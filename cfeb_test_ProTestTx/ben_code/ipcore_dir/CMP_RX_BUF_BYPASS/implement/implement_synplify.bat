...
COPY cmp_rx_buf_bypass_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\cmp_rx_buf_bypass_top.ucf -p xc6vlx195t-ff1156-1 cmp_rx_buf_bypass_top.edf cmp_rx_buf_bypass_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx195t-ff1156-1 -o mapped.ncd cmp_rx_buf_bypass_top.ngd
...
netgen -ofmt verilog -sim -dir . -tm cmp_rx_buf_bypass_top -w routed.ncd routed.v
