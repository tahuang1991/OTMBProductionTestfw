...
xst -ifn xst.scr
copy cmp_rec_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\cmp_rec_mmcm.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmp_rec_mmcm.ucf cmp_rec_mmcm_exdes

echo 'Running map'
map -timing -pr b cmp_rec_mmcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm cmp_rec_mmcm_exdes -w routed.ncd routed.v
cd ..
